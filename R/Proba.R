...
##
## These conversions are used to define simulation settings and
## to express the marginal survival model parameters in the
## form required by the proposed model.
############################################################
